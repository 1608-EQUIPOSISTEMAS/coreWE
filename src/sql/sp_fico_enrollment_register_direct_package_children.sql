-- Migracion idempotente: soporta inscripciones HIJAS de paquete. Si el payload
-- trae parent_enrollment_id, la inscripcion (a) se liga al padre y (b) es pago
-- cero (la venta vive en el padre; el hijo solo ocupa el aula). Cambios vs la
-- version anterior: var v_parent_enrollment_id, su lectura, su inclusion en
-- v_is_zero_payment y la columna parent_enrollment_id en el INSERT.
...
BEGIN
    ...
    -- Hijo de paquete (tiene padre) = pago cero: la venta esta en el padre.
    ...
    INSERT INTO public.enrollments (
        ...
        cat_b2b_doctype, agent_origin, parent_enrollment_id
    )
    VALUES (
        ...
        v_cat_b2b_doctype, v_agent_origin, v_parent_enrollment_id
    )
