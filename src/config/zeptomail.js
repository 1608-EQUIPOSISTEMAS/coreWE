...
export async function sendEmail ({ to, subject, htmlBody, replyTo, attachments, fromEmail, fromName }) {
  ...
  try {
    ...
    console.log(`[ZeptoMail] Email enviado a ${to} desde ${finalFromEmail} | messageId: ${info.messageId}`)
